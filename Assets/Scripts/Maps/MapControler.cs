...
public class MapControler : MonoBehaviour
{
    ...
    GameControler _GameControler; // Biến tham chiếu đến GameControler để kiểm tra trạng thái của trò chơi

    // Use this for initialization
    void Start()
    {
        // Tìm đối tượng GameControler trong scene và gán vào biến _GameControler
