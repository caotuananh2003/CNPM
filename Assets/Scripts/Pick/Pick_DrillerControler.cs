...
public class Pick_DrillerController : MonoBehaviour {
    ...
    {
        if (_GameController._GameObj.tag == "Player") _GameController._ListStatePickPlayer[4].Ammo -= 1; else _GameController._ListStatePickEnemy[4].Ammo -= 1;
        _SoundController.PlayDrillSound(true);
