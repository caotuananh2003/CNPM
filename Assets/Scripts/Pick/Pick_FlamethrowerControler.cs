...
public class Pick_FlamethrowerController : MonoBehaviour {
    ...
    {
        _SoundController.PlayFireSound(true);
        if (_GameController._GameObj.tag == "Player") _GameController._ListStatePickPlayer[16].Ammo -= 1; else _GameController._ListStatePickEnemy[16].Ammo -= 1;
