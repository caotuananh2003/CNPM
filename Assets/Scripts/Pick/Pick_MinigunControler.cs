...
public class Pick_MinigunController : MonoBehaviour {
    ...
    void Update()
    {
        if (isBallThrown && _BulletCount<35)
        {
    ...
    {
        if (_GameController._GameObj.tag == "Player") _GameController._ListStatePickPlayer[12].Ammo -= 1; else _GameController._ListStatePickEnemy[12].Ammo -= 1;
