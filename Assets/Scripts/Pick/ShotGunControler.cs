...
public class ShotGunControler : MonoBehaviour
{
    ...
    SoundControler _SoundControler; // Điều khiển âm thanh
    ...
    void Start()
    {
        ...
        _GameControler = FindObjectOfType<GameControler>(); // Tìm và tham chiếu đến đối tượng GameControler
        ...
        _SoundControler = FindObjectOfType<SoundControler>(); // Tìm SoundControler
    ...
    {
        _SoundControler.PlayShotgun_shotSound(true); // Âm thanh bắn
        ...
        */
        ...
        // Đặt cờ _CheckHit trong GameControler thành true, báo hiệu rằng viên đạn đã được bắn ra và trò chơi sẽ bắt đầu kiểm tra va chạm của đạn.
